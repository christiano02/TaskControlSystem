insert into tb_user (id, name, email, password, profile) values (1, 'João Silva', 'joao@email.com', '123456', 'ADMIN');
insert into tb_user (id, name, email, password, profile) values (2, 'Maria Souza', 'maria@email.com', 'abcdef', 'USER');
